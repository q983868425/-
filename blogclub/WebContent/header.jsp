		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container-fluid allwidth">
				<div class="navbar-header">
					<a class="navbar-brand" href="index.html">欢迎来到博客园</a>
				</div>
				<div>
					<ul class="nav navbar-nav">
						<li class="active"><a href="index.html">网站首页</a></li>
						<li><a href="bloglist.action">博客浏览</a></li>
						<c:if test="${current_user.id==1 }">
						...
						<c:if test="${current_user.id!=null }">
							<li><a href="blogcreate.jsp">博客创建</a></li>
							<li><a href="personblogschemalist.action?uid=${current_user.id }">我的博客</a></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<c:forEach items="${blogKindList}" var="kind">
									<li><a href="bloglist.action?kid=${kind.id }">${kind.name }</a></li>
									<li class="divider"></li>
								</c:forEach>
							</ul></li>
					</ul>
